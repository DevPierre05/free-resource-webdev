  ...
  return (
    <section className="mt-10 pb-10">
      <div className="tech_container gap-x-5 gap-y-8">
        <a
          href="https://scrimba.com/learn/introtocss"
          target="_blank"
        ...
        >
          ...
          <div className="flex justify-center items-center bg-[#f8f8fa] h-[calc(20rem-15rem)]">
            <h2 className="text-lg hover:text-emerald-500">CSS- Scrimba</h2>
          </div>
        </a>
        <a
        ...
        >
          ...
          />
          <div className="flex justify-center items-center bg-[#f8f8fa] h-[calc(20rem-15rem)]">
            <h2 className="text-lg hover:text-emerald-500">CSS- W3School</h2>
          </div>
        </a>
        <a
        ...
        >
          ...
          />
          <div className="flex justify-center items-center bg-[#f8f8fa] h-[calc(20rem-15rem)]">
            <h2 className="text-lg hover:text-emerald-500">CSS- CodeAcademy</h2>
          </div>
        </a>
        <a
        ...
        >
          ...
          />
          <div className="flex justify-center items-center bg-[#f8f8fa] h-[calc(20rem-15rem)]">
            <h2 className="text-lg hover:text-emerald-500">CSS- MDN Docs</h2>
          </div>
        </a>
        <a
        ...
        >
          ...
          />
          <div className="flex justify-center items-center bg-[#f8f8fa] h-[calc(20rem-15rem)]">
            <h2 className="text-lg hover:text-emerald-500">
              CSS- FreeCodeCamp
            </h2>
          </div>
        </a>
